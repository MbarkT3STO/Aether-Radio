/**
 * AboutModal — Apple-style about dialog (mobile).
 * Shown when the user taps the logo in Settings.
 * Self-contained: injects into document.body, cleans up on close.
 */
...
export class AboutModal {
    ...
    overlay.innerHTML = `
      ...
      <div class="am-dialog">
        ...
        <div class="am-info">
          ...
          <div class="am-info-row">
            <span class="am-info-label">Platform</span>
            <span class="am-info-value">Android</span>
          </div>
          <div class="am-info-row">
  ...
  private static async openGithub(): Promise<void> {
    const url = 'https://github.com/MbarkT3STO/Aether-Radio'
    try {
