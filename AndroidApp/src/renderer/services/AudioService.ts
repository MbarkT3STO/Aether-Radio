...
export class AudioService {
  ...
  private constructor() {
    ...
    // Do NOT set crossOrigin on Android — most radio streams don't send
    // CORS headers and it would block playback entirely.
    // The VisualizerService handles the case where AudioContext is unavailable.
